...
export function StaticTwoColumnSidebar() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Name */}
        <h1 style={{ fontSize: 10, color: "white", fontWeight: 700, marginBottom: 1, lineHeight: 1.2 }}>Sarah Chen</h1>
        <p style={{ fontSize: 7, color: "rgba(255,255,255,0.75)", marginBottom: 8 }}>Senior UX Designer</p>

        {/* Contact */}
        <div style={{ marginBottom: 8 }}>
          <h3 style={{ fontSize: 7, fontWeight: 600, color: "white", borderBottom: "1px solid rgba(255,255,255,0.3)", paddingBottom: 2, marginBottom: 3, textTransform: "uppercase", letterSpacing: 0.5 }}>Contact</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 2, fontSize: 6 }}>
            {["sarah.chen@email.com", "(415) 555-0142", "San Francisco, CA", "sarahchen.design"].map((item, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 3 }}>
                <span style={{ width: 6, height: 6, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.2)", display: "inline-block", flexShrink: 0 }} />
        ...
        {/* Skills */}
        <div style={{ marginBottom: 8 }}>
          <h3 style={{ fontSize: 7, fontWeight: 600, color: "white", borderBottom: "1px solid rgba(255,255,255,0.3)", paddingBottom: 2, marginBottom: 3, textTransform: "uppercase", letterSpacing: 0.5 }}>Skills</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 4, fontSize: 6 }}>
            {[
              { label: "Design Tools", items: ["Figma", "Sketch", "Adobe XD", "Framer"] },
        ...
        {/* Certifications */}
        <div>
          <h3 style={{ fontSize: 7, fontWeight: 600, color: "white", borderBottom: "1px solid rgba(255,255,255,0.3)", paddingBottom: 2, marginBottom: 3, textTransform: "uppercase", letterSpacing: 0.5 }}>Certifications</h3>
      ...
      <div style={{ flexGrow: 1, padding: 12, overflow: "hidden", color: "#374151" }}>
        ...
        <div style={{ marginBottom: 5 }}>
          <h2 style={{ fontSize: 7, fontWeight: 600, color: navy, textTransform: "uppercase", letterSpacing: 0.8, borderBottom: `1.5px solid ${navy}`, paddingBottom: 2, marginBottom: 3 }}>Summary</h2>
          <p>Award-winning UX designer with 6+ years crafting intuitive digital experiences for enterprise SaaS products.</p>
        </div>

        {/* Experience */}
        <div style={{ marginBottom: 5 }}>
          <h2 style={{ fontSize: 7, fontWeight: 600, color: navy, textTransform: "uppercase", letterSpacing: 0.8, borderBottom: `1.5px solid ${navy}`, paddingBottom: 2, marginBottom: 3 }}>Experience</h2>
          {/* Stripe */}
        ...
        {/* Education */}
        <div>
          <h2 style={{ fontSize: 7, fontWeight: 600, color: navy, textTransform: "uppercase", letterSpacing: 0.8, borderBottom: `1.5px solid ${navy}`, paddingBottom: 2, marginBottom: 3 }}>Education</h2>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
            <div>
